...
void QualcommCameraHardware::initDefaultParameters()
{
    ...
    LOGE("initDefaultParameters E");//add by fengzhe
...
void QualcommCameraHardware::findSensorType(){
	...
	LOGE("fengzhe %s:%d ret=%d",__func__,__LINE__,ret);
    if (ret) {
        unsigned int i;
...
bool QualcommCameraHardware::startCamera()
{
    ...
    *(void **)&LINK_mmcamera_camframe_callback =
    ...
    //*LINK_mmcamera_camframe_callback = receive_camframe_callback;//marked by fengzhe

    *(void **)&LINK_mmcamera_jpegfragment_callback =
        ::dlsym(libmmcamera, "mmcamera_jpegfragment_callback");
    //*LINK_mmcamera_jpegfragment_callback = receive_jpeg_fragment_callback;//marked by fengzhe

    *(void **)&LINK_mmcamera_jpeg_callback =
        ::dlsym(libmmcamera, "mmcamera_jpeg_callback");

    //*LINK_mmcamera_jpeg_callback = receive_jpeg_callback;//marked by fengzhe
    ...
    *(void **)&LINK_camframe_free_video = ::dlsym(libmmcamera, "cam_frame_add_free_video");
    ...
    //*(void **)&LINK_camframe_video_callback = ::dlsym(libmmcamera, "mmcamera_camframe_videocallback");//marked by fengzhe
...
//    *LINK_mmcamera_shutter_callback = receive_shutter_callback;
    ...
    *(void**)&LINK_jpeg_encoder_setMainImageQuality =//marked by fengzhe
...
sp<CameraHardwareInterface> QualcommCameraHardware::createInstance()
{
	...
	LOGE("fengzhe hooks here !!!");
    //cam->initDefaultParameters();//marked by fengzhe
