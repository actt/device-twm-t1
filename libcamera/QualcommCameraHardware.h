...
//void enqueue(struct fifo_queue *queue, struct fifo_node *node) {//fixed by fengzhe for compile error
inline void enqueue(struct fifo_queue *queue, struct fifo_node *node) {
...
//struct fifo_node *dequeue(struct fifo_queue *queue) { //fixed by fengzhe for compile error
inline struct fifo_node *dequeue(struct fifo_queue *queue) {
	if(queue->num_of_frames==0)
		return NULL;
